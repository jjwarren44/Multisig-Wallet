...
contract("Wallet", (accounts) => {
    ...
    beforeEach(async() => {
        wallet = await Wallet.new([accounts[0], accounts[1], accounts[2]], 2); // first 3 accounts are approvers, need 2 approvers
        await web3.eth.sendTransaction({ from: accounts[0], to: wallet.address, value: 1000 });
    });

    it("should have correct approers and quorum", async() => {
